...
from src.text import identifier, number, blank, comma, text_input
...
#         self.assertEqual(number('0B0010'), Okay(2, ''))
...
#         self.assertEqual(number.trim(blank).sep_by(comma.trim(blank))(' 1\n,\t2.3 ,4 ,  1e3'), Okay([1, 2.3, 4, 1e3], ''))
